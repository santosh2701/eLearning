...
<div id="middlePart">
<div id="rt">
<h2 id="hh">Search Course</h2> 
<div id="tb">
	<form name='f1' method='post' >
	<h4>
	Course Name:
	<input type='text' name='c_nam'>
	</h4>
	<h4>
	<input type='submit' name='Sub' id="btn" value='SEARCH'>
	</h4>
	</form>
...
else
{
	...
	$b=$row['c_name']; 
			...
			echo "<tr>";
			echo "<td id='a1'><img src=".$row['c_thum']." width=100% height=60></td>";
			echo "</tr>";
